...
<div class="col s12">
    <div  class="invoice-box">
        <table cellpadding="0" cellspacing="5" style="" align="center" style="border: 1px solid black;" width="90%">
            <tr class="top">
                <td colspan="2">
                    <table>
                        <tr>
            ...
            <tr>
            <td colspan="2">
            <table cellpadding="0" cellspacing="5" style="" align="center" width="90%" style="border-collapse: collapse;">
            <tr class="heading">
