...
class partPriceConfig{
    ...
    public static $materials = array(
        "ABS"=>         array("fullName"=>"Acrylonitrile Butadiene Styrene", "price"=>array("amount"=>0.20, "unit"=>"USD/g"),  "canBeVaporPolished"=>true,  "density"=>array("amount"=>1.04, "unit"=>"g/cm^3"), "colors"=>array("#FFFFFF")),
        "PLA"=>         array("fullName"=>"Polylactic acid",                 "price"=>array("amount"=>0.25, "unit"=>"USD/g"),  "canBeVaporPolished"=>true,  "density"=>array("amount"=>1.25, "unit"=>"g/cm^3"), "colors"=>array("#FFFFFF"))
    ...
    public static $printingCost = array("amount"=>"150.00","unit"=>"INR/hour");
    ...
    public static $deliveryCosts = array(
        "base"=>array("amount"=>5.80,"unit"=>"INR"),
        "weightPrice"=>array("amount"=>0.01,"unit"=>"INR/g")
    );
